...
CREATE TABLE "new_service_provider_services" (
    ...
    "offersQuoting" BOOLEAN NOT NULL DEFAULT true,
    "providesHomeService" BOOLEAN NOT NULL DEFAULT false,
    "providesLocalService" BOOLEAN NOT NULL DEFAULT true,
    "chargesTravel" BOOLEAN NOT NULL DEFAULT false,
    "quoteFee" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_service_provider_services" ("basePrice", "createdAt", "description", "id", "isActive", "offersScheduling", "providesHomeService", "providesLocalService", "serviceId", "serviceProviderId", "unit", "updatedAt") SELECT "basePrice", "createdAt", "description", "id", "isActive", "offersScheduling", "providesHomeService", "providesLocalService", "serviceId", "serviceProviderId", "unit", "updatedAt" FROM "service_provider_services";
