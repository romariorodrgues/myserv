...
INSERT INTO "new_service_provider_services" ("basePrice", "createdAt", "description", "id", "isActive", "offersScheduling", "providesHomeService", "serviceId", "serviceProviderId", "unit", "updatedAt") SELECT "basePrice", "createdAt", "description", "id", "isActive", "offersScheduling", "providesHomeService", "serviceId", "serviceProviderId", "unit", "updatedAt" FROM "service_provider_services";
