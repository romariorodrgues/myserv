 ...
 * 
 * Reusable sheet component for side panels and drawers
 */
...
const sheetVariants = cva(
  "fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        top: "inset-x-0 top-0 border-b transition-all duration-300 ease-in-out data-[state=open]:animate-fade-slide-down data-[state=closed]:animate-fade-slide-up"
,
        bottom:
